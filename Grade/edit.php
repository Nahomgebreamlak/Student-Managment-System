...
$sql="select student.sid,student.fname, student.lname ,grade.courseid ,grade.Agrade from student Inner JOIN grade on grade.sid=student.sid where grade.courseid='".$_POST['searchinput1']."' and student.sid='".$_POST['searchinput']."'";
...
echo '<option value="EX"';
   if($row['Agrade']=='EX'){echo "selected='true'";} 
   echo ">Exempted</option>";
