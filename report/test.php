...
$sql = "SELECT course.ccode,course.credithours,course.cname,grade.Agrade,grade.Ngrade FROM grade INNER JOIN course  ON course.cname= grade.Courseid or course.ccode= grade.Courseid  
...
$sql = "SELECT course.ccode,course.credithours,course.cname,grade.Agrade,grade.Ngrade FROM grade INNER JOIN course  ON course.cname= grade.Courseid or course.ccode= grade.Courseid    
where grade.sid='".$_POST['searchinput']."'";
...
<div class="w3-container">
  ...
  <table class="w3-table">
    ...
    <tr>
      ...
      <td><?php echo isset($_POST['tcredithour'])?$_POST['tcredithour']:"notset";     ?></td>
      <td><?php echo isset($_POST['tgrade'])?$_POST['tgrade']:"notset";     ?></td>
      <td><?php echo isset($_POST['grade'])?round($_POST['grade'],2):"notset";     ?></td>
...
<td><?php echo isset($_POST['Ctcredithour'])?$_POST['Ctcredithour']:"notset";     ?></td>
      <td><?php echo isset($_POST['Ctgrade'])?$_POST['Ctgrade']:"notset";     ?></td>
      <td><?php echo isset($_POST['Cgrade'])?round($_POST['Cgrade'],2):"notset";     ?></td>
...
<div> Acadamic Standing : Good Standing
</div>
...
<div class="w3-cell-row" style="margin-top: 150px; ">
  <div class="w3-container  w3-cell" style="float: left;">
    <p><b><u><?php echo date("Y/M/D");?></u></b></p>
    <p>Date of Issue</p>
  </div>
